package com.example.user.coolrecycleview.recycle.ChildDrawers;
...
import com.example.user.coolrecycleview.recycle.CoolChildDrawer;

/**
 * Created by user on 8/19/2016.
 */
public class RotationRightChildDrawer implements CoolChildDrawer {
    ...
    private int rotationCoef = 1;

    public RotationRightChildDrawer() {
        mPaint.setAntiAlias(true);
    }

    public RotationRightChildDrawer(int rotationCoef) {
        mPaint.setAntiAlias(true);
        this.rotationCoef = rotationCoef;
    }

    @Override
    public boolean drawChild(Canvas canvas, View child, long drawingTime, View parent) {
        ...
        //center of list
        final int parentCenterY = parent.getHeight() / 2;
        ...
        final int r = parent.getHeight() / 2;
    ...
    private void prepareMatrix(final Matrix outMatrix, int distanceY, int r){
        ...
        double degree = (90 - (180 / Math.PI) * radians)*rotationCoef;
